...
const stores: Store[] = [
  {
    name: "YachtBeach Monaco Marina",
    address: "Quai Antoine 1er, Port Hercule",
    city: "Monte-Carlo",
    country: "Monaco",
  ...
  },
  {
    ...
    address: "Via della Marina, Porto Cervo Marina",
    city: "Costa Smeralda",
    country: "Italy",
    phone: "+39 0789 92288",
  ...
  },
  {
    ...
    address: "1 Collins Avenue, South Beach Marina",
    city: "Miami Beach, FL",
    country: "USA",
  ...
  },
  {
    ...
    address: "Nouveau Port, Quai de l'Épi",
    city: "Saint-Tropez",
    country: "France",
  ...
  },
  {
    ...
    address: "Bay Street, Nassau Harbour",
    city: "Nassau",
    country: "Bahamas",
  ...
  },
  {
    ...
    address: "Dubai Marina Walk, Marina Promenade",
    city: "Dubai",
    country: "UAE",
  ...
  },
  {
    ...
    address: "Puerto Banús, Muelle Rivera",
    city: "Marbella",
    country: "Spain",
  ...
  },
  {
    ...
    address: "Port Vauban, Quai des Milliardaires",
    city: "Antibes",
    country: "France",
...
export default function StoresPage() {
  return (
    <>
      <SEO 
        title="Store Locator | Find Our Yacht & Beach Stores"
        description="Find YachtBeach stores near you. Visit our luxury yacht and beach equipment showrooms in Monaco, Miami, Dubai, and more premium locations worldwide."
      />
